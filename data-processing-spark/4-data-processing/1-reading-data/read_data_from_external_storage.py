...
def run_code(spark):
    print("==========================================")
    print("Credentials to connect to S3(we use minio) has already been set in spark-defaults.conf")
    print("==========================================")
     
    # Write a sample of orders data into S3 for this example

    spark.sql("select * from tpch.orders limit 500").write.parquet("s3a://tpch/sample/orders.parquet")
