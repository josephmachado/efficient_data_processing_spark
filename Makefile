...
pyspark:
	docker exec -ti local-spark bash -c '$$SPARK_HOME/bin/pyspark'
...
run-code-proj:
	docker exec -ti local-spark bash -c '$$SPARK_HOME/bin/spark-submit --master local[*] $$SPARK_HOME/work-dir/capstone/run_code.py'
