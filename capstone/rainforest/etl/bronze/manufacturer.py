...
class ManufacturerBronzeETL(TableETL):
    ...
    def transform_upstream(self, upstream_datasets: List[ETLDataSet]) -> ETLDataSet:
        ...
        transformed_data = manufacturer_data.withColumn("etl_inserted", lit(current_timestamp))
    ...
    def load(self, data: ETLDataSet) -> None:
        ...
        manufacturer_data.write.format(data.data_format).mode("overwrite").partitionBy(
            data.partition_keys
    ...
    def read(self, partition_keys: Optional[List[str]] = None) -> ETLDataSet:
        ...
        manufacturer_data = self.spark.read.format(self.data_format).load(self.storage_path)
